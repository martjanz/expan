...
defaults.height = $("#chart").innerWidth() * 9/16 - (defaults.margin.top + defaults.margin.bottom);
    ...
    function text(text) {
        text.each(function(d) {
            ...
            tspan = textSel.text(null)
                ...
                .append("tspan")
                .text(d.key + " (" + formatNumber(d.value) + ")");

            trimTxt = d.key;

            while (tspan.node().getComputedTextLength() > rectWidth - 5) {
